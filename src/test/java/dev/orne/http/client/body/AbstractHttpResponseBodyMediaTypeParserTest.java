...
/**
 * Unit tests for {@code AbstractHttpResponseBodyMediaTypeParser}.
 * 
 * @author <a href="mailto:wamphiry@orne.dev">(w) Iker Hernaez</a>
 * @version 1.0, 2023-08
 * @since 0.1
 * @see AbstractHttpResponseBodyMediaTypeParser
 */
@Tag("ut")
class AbstractHttpResponseBodyMediaTypeParserTest
extends HttpResponseBodyParserTest {
     ...
     */
    @Override
    protected @NotNull AbstractHttpResponseBodyMediaTypeParser<?> createParser() {
        return spy(AbstractHttpResponseBodyMediaTypeParser.class);
    }
    ...
    throws Throwable {
        ...
        final AbstractHttpResponseBodyMediaTypeParser<?> parser = createParser();

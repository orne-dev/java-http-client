...
/**
 * Interface for parsers of JSON HTTP response body entities.
 * 
 ...
 * @since 0.1
 */
public interface XmlHttpResponseBodyParser<E>
extends HttpResponseBodyMediaTypeParser<E> {

    /** The default content type: {@code application/xml}. */
    public static final @NotNull ContentType DEFAULT_CONTENT_TYPE = 
            ContentType.of(MediaTypes.Application.XML);

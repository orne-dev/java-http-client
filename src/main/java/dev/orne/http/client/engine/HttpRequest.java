...
public interface HttpRequest {
    ...
    /**
     * Sets the HTTP request body generated by the specified producer.
     * 
     * @param producer The body content producer.
     * @throws HttpClientException If an error occurs setting the HTTP
     * request body.
     */
    default void setBody(
            @NotNull HttpRequestBodyProducer producer)
    throws HttpClientException {
        producer.generate(this);
    }
